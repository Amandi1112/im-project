    ...
    <div class="container">
        <header class="header">
            <div class="d-flex align-items-center">
                ...
                <h1 class="header-title">T&C Co-op City Shop</h1>
            </div>
            <div class="user-menu">
                <div class="user-info">
                    <div class="user-avatar">
        ...
        <div class="welcome-banner animate__animated animate__fadeIn">
            <div class="welcome-content">
                ...
                <p class="welcome-text">Manage your co-op shop operations efficiently. Monitor real-time statistics, track inventory, and streamline member services with our comprehensive tools.</p>
                <div class="mt-3">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="employeeDropdown">
                                <li><a class="dropdown-item" href="personal_detail.php"><i class="fas fa-id-card"></i> Personal Details</a></li>
                                <li><a class="dropdown-item" href="educational_background.php"><i class="fas fa-graduation-cap"></i> Educational Background</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
        ...
        <div class="dashboard-grid">
            <div class="card animate__animated animate__fadeInUp" style="animation-delay: 0.3s;">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p class="mb-1"><strong><i class="fas fa-envelope me-2"></i>Email:</strong> <?php echo $_SESSION['user_email']; ?></p>
                        <p class="mb-3"><strong><i class="fas fa-shield-alt me-2"></i>Security:</strong> <span class="badge bg-success">Active</span></p>
                    </div>
            ...
            <div class="card animate__animated animate__fadeInUp" style="animation-delay: 0.4s;">
                <div class="card-header">
                    <i class="fas fa-award"></i> Member Benefits
                </div>
                <div class="card-body">
                    <div class="timeline">
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <div class="timeline-time"><i class="fas fa-clock"></i> Always Available</div>
                                <div class="timeline-title">Best Prices & Offers</div>
                                <div class="timeline-text">Providing quality items at lowest prices with member credit facilities</div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item">
                            <div class="timeline-dot"><i class="fas fa-check"></i></div>
                            <div class="timeline-content">
                                <div class="timeline-time"><i class="fas fa-clock"></i> Monthly Updates</div>
                                <div class="timeline-title">Wide Product Selection</div>
                                <div class="timeline-text">Diverse range of products from trusted brands, with new additions monthly</div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item">
                            <div class="timeline-dot"><i class="fas fa-check"></i></div>
                            <div class="timeline-content">
                                <div class="timeline-time"><i class="fas fa-clock"></i> Fast Service</div>
                                <div class="timeline-title">Efficient Management</div>
                                <div class="timeline-text">Streamlined operations for quick service and member satisfaction</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card animate__animated animate__fadeInUp" style="animation-delay: 0.5s;">
                ...
                <div class="card-body">
                    <a href="display_coop_number.php" class="quick-link-item">
                        <div class="quick-link-icon members">
                            <i class="fas fa-users"></i>
                        </div>
                        <div class="quick-link-text">
                            <div class="quick-link-title">Members Directory</div>
                            <div class="quick-link-desc">View and manage co-op members</div>
                        </div>
                        <i class="fas fa-chevron-right text-muted"></i>
                    </a>

                    <a href="display_registered_suppliers.php" class="quick-link-item">
                        <div class="quick-link-icon suppliers">
                            <i class="fas fa-truck"></i>
                        </div>
                        <div class="quick-link-text">
                            <div class="quick-link-title">Supplier Database</div>
                            <div class="quick-link-desc">Manage supplier relationships</div>
                        </div>
                        <i class="fas fa-chevron-right text-muted"></i>
                    </a>

                    <a href="manage_categories_items.php" class="quick-link-item">
                        <div class="quick-link-icon inventory">
                            <i class="fas fa-tags"></i>
                        </div>
                        <div class="quick-link-text">
                            <div class="quick-link-title">Categories & Items</div>
                            <div class="quick-link-desc">Manage product inventory</div>
                        </div>
                        <i class="fas fa-chevron-right text-muted"></i>
                    </a>

                    <a href="sales_summary_report.php" class="quick-link-item mb-0">
                        <div class="quick-link-icon reports">
                            <i class="fas fa-chart-line"></i>
                        </div>
                        <div class="quick-link-text">
                            <div class="quick-link-title">Sales Reports</div>
                            <div class="quick-link-desc">View financial performance</div>
                        </div>
                        <i class="fas fa-chevron-right text-muted"></i>
                    </a>
                </div>
