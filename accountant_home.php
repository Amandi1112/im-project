    ...
    <div class="container">
            ...
            <div class="user-menu">
                <div class="user-info">
                    ...
                    <div>
                        ...
                        <small  style="font-weight: bold; color:black;">Accountant</small>
                    </div>
                </div>
        ...
        <div class="welcome-banner animate__animated animate__fadeIn">
            <div class="welcome-content">
                <h2 class="welcome-title" style="color:white; font-weight:bold; font-size:35px;">Welcome to the Accountant Dashboard</h2>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="suppliersDropdown">
                                <li><a class="dropdown-item" href="display_registered_suppliers2.php" style="font-size: 17px; color:black;"><i class="fas fa-user-plus"></i> View Suppliers</a></li>
                                <li><a class="dropdown-item" href="display_purchase_details2.php" style="font-size: 17px; color:black;"><i class="fas fa-shopping-basket"></i> View Purchase Details</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="membersDropdown">
                                ...
                                <li><a class="dropdown-item" href="view_registered_members2.php" style="font-size: 17px; color:black;"><i class="fas fa-id-badge"></i> Membership Numbers</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="reportsDropdown">
                                ...
                                <li><a class="dropdown-item" href="display_purchase_details2.php" style="font-size: 17px; color:black;"><i class="fas fa-file-alt"></i> Purchase Details Report</a></li>
