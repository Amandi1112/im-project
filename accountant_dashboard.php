...
<body>
    <div class="container">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="display_registered_suppliers.php">Suppliers List</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="display_coop_number.php">Members</a></li>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="quick-actions mt-4">
                    <a href="customer_credit.php" class="action-btn">
                        <i class="fas fa-file-alt"></i> View Sales Report
                    </a>
                    <a href="safety_stock.php" class="action-btn">
        ...
        <div class="dashboard-grid">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-tasks me-2"></i>Providing Benefits
                </div>
                <div class="card-body">
                    <div class="timeline">
