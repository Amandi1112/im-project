...
<head>
    ...
    <style>
        ...
        /* Overview Section */
        .welcome-banner {
            background: linear-gradient(45deg, var(--primary-color),rgb(235, 66, 244));
            color: white;
            padding: 25px;
            border-radius: 8px;
            margin-bottom: 30px;
    ...
    <div class="container">
        ...
        <div class="welcome-banner">
            <div class="welcome-content">
                <h2 class="welcome-title">Welcome to the Accountant Dashboard</h2>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="display_registered_suppliers.php">Registered Suppliers</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="member copy.php">Bank Memberships</a></li>
                                <li><a class="dropdown-item" href="display_coop_number copy.php">Co-op city Memberships</a></li>
        ...
        <div class="dashboard-grid">
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-user-shield me-2"></i>Accountant Profile
                </div>
                <div class="card-body">
